...
do_comp() {
	...
	python3 ${SCRIPT_DIR}/scripts/pandas_merge.py $metadata full_dataset_diversities/total_beta_diversity.csv full_dataset_diversities/meta_beta_diversity.csv
